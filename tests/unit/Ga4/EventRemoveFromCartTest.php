...
class EventRemoveFromCartTest extends \Codeception\Test\Unit
{
    ...
    public function testRender(): void
    {
        ...
        $this->tester->assertEquals('remove_from_cart', $json->event);
    ...
    public function testRequiredProperties(): void
    {
        $this->tester->expectThrowable(
            new \LogicException("'EventRemoveFromCart' requires properties value, currency"),
            static function () {
                new DataLayer(new EventRemoveFromCart());
            }
        );

        $this->tester->expectThrowable(
            new \LogicException("'EventRemoveFromCart' requires items"),
            static function () {
                $event = new EventRemoveFromCart();
                $event->value = 12.3;
                $event->currency = 'EUR';
