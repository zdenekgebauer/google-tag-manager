...
class EventViewItemListTest extends \Codeception\Test\Unit
{
    ...
    public function testRender(): void
    {
        ...
        $this->tester->assertEquals('view_item_list', $json->event);
    ...
    public function testRequiredProperties(): void
    {
        $this->tester->expectThrowable(
            new \LogicException("'EventViewItemList' requires items"),
            static function () {
                new DataLayer(new EventViewItemList());
            }
        );
    }
