...
class EventViewCartTest extends \Codeception\Test\Unit
{
    ...
    public function testRender(): void
    {
        ...
        $this->tester->assertEquals('view_cart', $json->event);
    ...
    public function testRequiredProperties(): void
    {
        $this->tester->expectThrowable(
            new \LogicException("'EventViewCart' requires properties value, currency"),
            static function () {
                new DataLayer(new EventViewCart());
            }
        );

        $this->tester->expectThrowable(
            new \LogicException("'EventViewCart' requires items"),
            static function () {
                $event = new EventViewCart();
                $event->value = 12.3;
                $event->currency = 'EUR';
