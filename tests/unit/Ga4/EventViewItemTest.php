...
class EventViewItemTest extends \Codeception\Test\Unit
{
    ...
    public function testRender(): void
    {
        ...
        $this->tester->assertEquals('view_item', $json->event);
    ...
    public function testRequiredProperties(): void
    {
        $this->tester->expectThrowable(
            new \LogicException("'EventViewItem' requires items"),
            static function () {
                new DataLayer(new EventViewItem());
            }
        );
    }
