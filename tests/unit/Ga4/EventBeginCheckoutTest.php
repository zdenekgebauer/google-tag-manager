...
class EventBeginCheckoutTest extends \Codeception\Test\Unit
{
    ...
    public function testRender(): void
    {
        ...
        $this->tester->assertEquals('begin_checkout', $json->event);
    ...
    public function testRequiredProperties(): void
    {
        $this->tester->expectThrowable(
            new \LogicException("'EventBeginCheckout' requires items"),
            static function () {
                new DataLayer(new EventBeginCheckout());
            }
        );
    }
